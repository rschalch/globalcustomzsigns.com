    ...
    class Auth extends CI_Controller
    {
        ...
        public function index()
        {
            ...
            if (!$this->ion_auth->logged_in()) {
                ...
                $this->session->set_flashdata('page', 'auth/users');
                $this->_render_page('layouts/admin', $this->data);
            }
        }
        ...
        public function deactivate($id = null)
        {
            ...
            if ($this->form_validation->run() == false) {
                ...
                // set data and load the right page
                $this->session->set_flashdata('page', 'auth/deactivate_user');
                $this->_render_page('layouts/admin', $this->data);
            } else {
        ...
        public function create_user()
        {
            ...
            if ($this->form_validation->run() == true && $this->ion_auth->register($identity, $password, $email, $additional_data)) {
                ...
                // set data and load the right page
                $this->session->set_flashdata('page', 'auth/create_user');
                $this->_render_page('layouts/admin', $this->data);
            }
        }
        ...
        public function edit_user($id)
        {
            ...
            // set data and load the right page
            $this->session->set_flashdata('page', 'auth/edit_user');
            $this->_render_page('layouts/admin', $this->data);
        }
        ...
        public function delete_user($id)
        {
            ...
            $this->session->set_flashdata('page', 'auth/delete_user');
            $this->_render_page('layouts/admin', $this->data);
        }
        ...
        public function create_group()
        {
            ...
            if ($this->form_validation->run() == true) {
                ...
                // set data and load the right page
                $this->session->set_flashdata('page', 'create_group');
                $this->_render_page('layouts/admin', $this->data);
            }
        }
        ...
        public function edit_group($id)
        {
            ...
            // set data and load the right page
            $this->session->set_flashdata('page', 'auth/edit_group');
            $this->_render_page('layouts/admin', $this->data);
        }
        ...
        {
            echo ($this->ion_auth->is_admin() ? 'success' : 'error');
        }
    }
